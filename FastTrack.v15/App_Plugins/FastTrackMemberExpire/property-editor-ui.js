...
var A = Object.defineProperty, x = Object.getOwnPropertyDescriptor, d = (t) => {
  throw TypeError(t);
}, l = (t, e, a, s) => {
  for (var i = s > 1 ? void 0 : s ? x(e, a) : e, u = t.length - 1, h; u >= 0; u--)
    (h = t[u]) && (i = (s ? h(e, a, i) : h(i)) || i);
  return s && i && A(e, a, i), i;
}, C = (t, e, a) => e.has(t) || d("Cannot " + a), M = (t, e, a) => e.has(t) ? d("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), o = (t, e, a) => (C(t, e, "access private method"), a), n, f, _, g, m;
...
_ = function(t) {
  this.value = t.target.value, console.log(this.value), this.dispatchEvent(new c());
};
g = function(t) {
  const e = parseInt(t);
...
m = function() {
  ...
  if (t)
    return L(
      t,
      (s) => p`
          <uui-button look="secondary" @click=${() => o(this, n, g).call(this, s)}>
            Add ${s} months
          </uui-button>
        `
    );
